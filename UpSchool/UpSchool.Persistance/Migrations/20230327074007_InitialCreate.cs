        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastModidifiedOn = table.Column<DateTimeOffset>(type: "datetime(6)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "Accounts",
                columns: new[] { "Id", "CreatedOn", "IsFavourite", "LastModidifiedOn", "Password", "Title", "Url", "UserName" },
                values: new object[,]
                {
                    ...
                    { new Guid("c2b18a4f-7d5e-4696-932b-6797b7f4d661"), new DateTimeOffset(new DateTime(2023, 3, 21, 5, 43, 17, 0, DateTimeKind.Unspecified), new TimeSpan(0, 3, 0, 0, 0)), true, null, "MTIzY291cnNlcmExMjM=", "Coursera", null, "coursera_user" },
